...
import { COMPETITION_SCORE_LIMIT } from "~/utils/competitionLeaderboard";
import {
...
import { useCompetitionDetailState } from "./useCompetitionDetailState";
...
export default function CompetitionDetail() {
  ...
  useEffect(() => {
    ...
    try {
      const stored = localStorage.getItem(`comp:joined-banner:${effectiveId}`);
      setJoinedBannerExpanded(stored !== "0");
    } catch {
              ...
              >
                ...
                >
                  ...
                  <span className="mt-0.5 block text-sm font-semibold leading-snug text-guinness-cream">
                    {winRuleLabelI18n(t, competition.win_rule)}
