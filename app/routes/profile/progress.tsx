        ...
        <>
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.label}
                className="rounded-xl border border-[#372C16] bg-guinness-brown/35 p-4 text-center"
              >
          ...
          <div className="rounded-2xl border border-[#372C16] bg-guinness-brown/30 p-4 sm:p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    accent: "bg-[#372C16] ring-1 ring-guinness-gold/25",
                  },
                  {
                    label: "Recent volume",
                  ...
                  <div key={item.label} className="space-y-1.5">
                    ...
                    <div className="h-3 overflow-hidden rounded-full border border-[#372C16]/80 bg-guinness-black/60">
                      <div
          ...
          <section className="rounded-2xl border border-[#372C16] bg-guinness-brown/30 p-5 sm:p-6">
                  ...
                  <li
                    ...
                    className={`grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 rounded-xl border px-3 py-3 sm:grid-cols-[auto_minmax(0,1.3fr)_repeat(3,auto)] sm:gap-4 ${
                      entry.isCurrentUser
                        ...
                        : "border-[#372C16] bg-guinness-black/30"
                    }`}
                  >
